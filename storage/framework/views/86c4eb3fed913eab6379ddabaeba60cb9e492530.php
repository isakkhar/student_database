                    ...
                    <form action="<?php echo e(route('updateStudent', $student->id)); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="department" id="department" class="form-control">
                                <option value="Web App Development" <?php echo e(old('department', $student->department)=='Web App Development' ? "selected ='selected'" : ''); ?>>Web App Development</option>
                                <option value="Mobile App Development" <?php echo e(old('department', $student->department)=='Mobile App Development' ? "selected ='selected'" : ''); ?>>Mobile App Development</option>
                                <option value="UI/UX" <?php echo e(old('department', $student->department)=='department' ? "selected ='selected'" : ''); ?>>UI/UX</option>
                            </select>
                        </div>
                        <div class="form-group">
